...
export default function SummaryCards({
  ...
  return (
    <AnimatedStagger 
      className={`grid grid-cols-1 md:grid-cols-2 ${incomeTrackingDisabled ? "lg:grid-cols-2" : "lg:grid-cols-4"} gap-4 mb-6`}
      staggerDelay={0.08}
      initialDelay={0}
    >
        ...
        <Card style={{ borderColor: "rgba(52, 211, 153, 0.5)" }}>
          <div className="px-4 py-3">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400">{t("totalIncome")}</h3>
                <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} className="text-lg font-semibold text-green-600 dark:text-green-400">
      ...
      <Card style={{ borderColor: "rgba(248, 113, 113, 0.5)" }}>
        <div className="px-4 py-3">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400">{t("totalExpenses")}</h3>
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} className="text-lg font-semibold text-red-600 dark:text-red-400">
        ...
        <Card style={{ borderColor: "rgba(168, 85, 247, 0.5)" }}>
          <div className="px-4 py-3">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400">{t("netSavings")}</h3>
                <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} className="text-lg font-semibold text-purple-600 dark:text-purple-400">
      ...
      <Card style={{ borderColor: "rgba(249, 115, 22, 0.5)" }}>
        <div className="px-4 py-3">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400">{`Ø ${averageLabel}`}</h3>
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} className="text-lg font-semibold text-orange-600 dark:text-orange-400">
