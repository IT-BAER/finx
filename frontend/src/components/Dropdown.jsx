          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                className="fixed z-[99999] bg-white/95 dark:bg-gray-800/95 shadow-2xl rounded-lg overflow-auto scrollbar-thin-modern border border-gray-200 dark:border-gray-700 ring-1 ring-black/5 dark:ring-white/10"
                style={{
                  left: "0px",
                  top: "0px",
                  width: "240px",
